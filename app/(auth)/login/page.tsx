...
import { Crown, Eye, EyeOff, Loader2, Scissors } from "lucide-react";
...
export default function LoginPage() {
  ...
  const {
    ...
    resolver: zodResolver(loginSchema) as any, // eslint-disable-line
  });
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="admin@houseoftailors.com"
                {...register("email")}
          ...
          <div className="mt-6 p-4 rounded-lg bg-secondary/50 border border-border">
            ...
            <p className="text-xs text-muted-foreground">Email: <span className="text-foreground">admin@houseoftailors.com</span></p>
