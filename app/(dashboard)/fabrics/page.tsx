...
async function FabricsContent({ searchParams }: { searchParams: Promise<{ search?: string; lowStock?: string }> }) {
...
export default function FabricsPage({ searchParams }: { searchParams: Promise<{ search?: string; lowStock?: string }> }) {
  return (
